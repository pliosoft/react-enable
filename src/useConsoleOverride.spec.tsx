...
describe('useConsoleOverride', () => {
  ...
  it('should set window.feature when consoleOverride is true', () => {
    renderHook(() => useConsoleOverride(true, testFeatures, mockTestFeature, mockDispatch));
  ...
  it('should not set window.feature when consoleOverride is false', () => {
    renderHook(() => useConsoleOverride(false, testFeatures, mockTestFeature, mockDispatch));
  ...
  it('should update window.feature when dependencies change', () => {
    const { rerender } = renderHook(
      ({ features, dispatch }) => useConsoleOverride(true, features, mockTestFeature, dispatch),
      {
    ...
    const newFeatures = [...testFeatures, { name: 'Feature3', description: 'New', defaultValue: false }];
  ...
  it('should handle existing window.feature gracefully', () => {
    const existingFeature = new GlobalEnable(mockDispatch, mockTestFeature, testFeatures);
...
describe('GlobalEnable', () => {
  ...
  describe('enable', () => {
    it('should dispatch ENABLE action', () => {
      ...
      expect(mockDispatch).toHaveBeenCalledWith({ type: 'ENABLE', name: 'Feature1' });
    });

    it('should work with any feature name', () => {
      globalEnable.enable('SomeFeature');

      expect(mockDispatch).toHaveBeenCalledWith({ type: 'ENABLE', name: 'SomeFeature' });
    });
  });
  ...
  describe('disable', () => {
    it('should dispatch DISABLE action', () => {
      ...
      expect(mockDispatch).toHaveBeenCalledWith({ type: 'DISABLE', name: 'Feature2' });
    });

    it('should work with any feature name', () => {
      globalEnable.disable('SomeFeature');

      expect(mockDispatch).toHaveBeenCalledWith({ type: 'DISABLE', name: 'SomeFeature' });
    });
  });
  ...
  describe('toggle', () => {
    it('should dispatch TOGGLE action', () => {
      ...
      expect(mockDispatch).toHaveBeenCalledWith({ type: 'TOGGLE', name: 'Feature1' });
    });

    it('should work with any feature name', () => {
      globalEnable.toggle('SomeFeature');

      expect(mockDispatch).toHaveBeenCalledWith({ type: 'TOGGLE', name: 'SomeFeature' });
    });
  });
  ...
  describe('unset', () => {
    it('should dispatch UNSET action', () => {
      ...
      expect(mockDispatch).toHaveBeenCalledWith({ type: 'UNSET', name: 'Feature1' });
    });

    it('should work with any feature name', () => {
      globalEnable.unset('SomeFeature');

      expect(mockDispatch).toHaveBeenCalledWith({ type: 'UNSET', name: 'SomeFeature' });
    });
  });
  ...
  describe('integration', () => {
    ...
    it('should maintain consistent behavior across multiple calls', () => {
      ...
      expect(mockDispatch).toHaveBeenCalledTimes(3);
      expect(mockDispatch).toHaveBeenNthCalledWith(1, { type: 'ENABLE', name: 'Feature1' });
      expect(mockDispatch).toHaveBeenNthCalledWith(2, { type: 'ENABLE', name: 'Feature1' });
      expect(mockDispatch).toHaveBeenNthCalledWith(3, { type: 'ENABLE', name: 'Feature1' });
    });
  });
});
