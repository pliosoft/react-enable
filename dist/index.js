...
function useLoadActive(storage, dispatch) {
    React.useEffect(function () {
        if (storage != null) {
            try {
...
function usePersistActive(active, storage) {
    var strState = storage == null ? undefined : JSON.stringify(Array.from(active).sort());
    React.useEffect(function () {
